...
def get_response(user_query, chat_history):
    ...
    # llm = ChatOpenAI(base_url="http://localhost:8080/v1", api_key="lm-studio")
    ## Using AI Server Maybe GPT4ALL
    # llm = ChatOpenAI(base_url="http://localhost:4891/v1", api_key="")
    ## Using Ollama
